...
- **Links wie im LTS:** jeder Link eine Fläche über die volle Leistenhöhe (28 px oben/unten, 18 px seitlich, 992–1199 px: 10 px); beim Hover wird die Fläche dunkler (`#1f282d`), keine Unterstreichung. Die Links brechen nie um; passt das Copyright nicht mehr daneben, steht es mittig in einer eigenen Zeile.
